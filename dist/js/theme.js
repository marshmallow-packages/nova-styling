...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__icons_IconToggle_vue__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__icons_IconToggle_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__icons_IconToggle_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        IconToggle: __WEBPACK_IMPORTED_MODULE_0__icons_IconToggle_vue___default.a
    },
    mounted: function mounted() {
        ...
        console.log('TOP');
        console.log('This', this.darkThemeOn);
        console.log('Prefers', prefersDarkScheme);
        console.log('Local', localStorage.darkThemeOn);

        if (localStorage.darkThemeOn === undefined) {
...
Component.options.__file = "resources/js/components/icons/IconToggle.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9e4beea6", Component.options)
  } else {
    hotAPI.reload("data-v-9e4beea6", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-9e4beea6", module.exports)
  }
}
